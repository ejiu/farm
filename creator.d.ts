	...
	*/
	...
	export class loader extends Pipeline {		
		...
		*/
		...
		``` 
		*/
		//TODO 此处需要修改，之前强制要求传入cc.Asset类型但是cc.SpriteAtlas是cc.RawAsset类型，所以这里不要限定传入类型  --by 许强
		static loadRes(url: string, type, progressCallback: (completedCount: number, totalCount: number, item: any) => void, completeCallback: ((error: Error, resource: any) => void)|null): void;
		static loadRes(url: string, type, completeCallback: (error: Error, resource: any) => void): void;
		static loadRes(url: string, type): void;
